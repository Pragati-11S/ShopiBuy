...
import i2 from '../../components/img/i2.jpg'
...
const Contactus = () => {
    ...
    return (
        ...
        <div className="headerContact">
            <Image className="imageContact" src={i2} alt="contactImage" objectFit="cover" style={{width:'1800px'}}/>
            <div className="text">
                <h2>Contact</h2>  
            </div>
            ...
            <div className="showAdrss">
                <div className="box">
                    ...
                    <div className="adressCtn">
                        ...
                        <h3>Lets Talk</h3>
                        <p className="infoCtn">9876546754</p>
                    </div>
                </div>
                <div className="box">
                    ...
                    <div className="adressCtn">
                        ...
                        <h3>Sale Support</h3>
                        <p className="infoCtn"> shopibuy@gmail.com</p>
                    </div>
                </div>
            </div>
        </div>
