...
import { AiOutlineUser, HiOutlineMail, IoIosArrowDown,IoLocationOutline,AiOutlinePhone } from 'react-icons/all';
...
const Edituser = ({match,history}) => {
    ...
    const submitHandler = (e) => {
        e.preventDefault()
        dispatch(updateUser({_id: userId,name,address,pincode,phonenumber,email,isAdmin}))
    }
            ...
            <div className ='formedit'>
               ...
               <div className="input-div zz">
                   ...
                   <InputGroup>
                      ...
                      <InputRightElement children={<IoLocationOutline/>} />
                   </InputGroup>
           		   </div>
           		</div>
               <div className="input-div zz">
               ...
               <div className="input-div zz">
                   ...
                   <InputGroup>
                      ...
                      <InputRightElement children={<AiOutlinePhone/>} />
                   </InputGroup>
           		   </div>
           		</div>
