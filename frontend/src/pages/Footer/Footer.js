            ...
            <footer>
                <div className="Categorie">
                    ...
                    <ul>
                        ...
                        <li><Link to = '/shop/?cg=Shoes'>Mobiles</Link></li>
                        <li><Link to = '/shop/?cg=Watches'>Home-Appliances</Link></li>
                    </ul>
                </div>
                ...
                <div className="footerGetInTouch">
                    <h1>Get in touch</h1>
                    <ul>
                        <p>Any questions? Let us know in store by dropping a mail on shopibuy@gmail.com or call us on 9876546754</p>
