    ...
    useEffect(() => {
        ...
        if(successUpdate){
            ...
            if(!product.name || product._id !== productId){
                ...
                setMobileselected(category.includes("Mobile"))
               setMenselected(category.includes("Men"))
                setWomenselected(category.includes("Women"))
                setHomeselected(category.includes("Home-Appliances"))
            ...
            <div className ='formedit'>
                ...
                Name :
                   ...
                   <div className="input-div one">
                      ...
                      <Checkbox onChange = {() =>{checkboxhandlercg('Women') ; setWomenselected(!Womenselected)}} isChecked = {Womenselected}>Women </Checkbox>
                      <Checkbox onChange = {() =>{checkboxhandlercg('Mobile'); setMobileselected(!Mobileselected)}} isChecked = {Mobileselected}>Mobile </Checkbox>
                      <Checkbox onChange = {() =>{checkboxhandlercg('Home-Appliances') ; setHomeselected(!Homeselected)}} isChecked = {Homeselected}>Home-Appliances </Checkbox>
